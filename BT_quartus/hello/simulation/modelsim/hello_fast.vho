...
-- HEX0[0]	=>  Location: PIN_G12,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- HEX0[1]	=>  Location: PIN_A14,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- HEX0[2]	=>  Location: PIN_D14,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- HEX0[3]	=>  Location: PIN_B11,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- HEX0[4]	=>  Location: PIN_B12,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
...
-- SW[2]	=>  Location: PIN_C12,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
...
-- Equation(s):
-- \HEX0~0_combout\ = (\SW~combout\(1)) # (\SW~combout\(2) $ (!\SW~combout\(0)))
...
\Decoder2~0\ : cycloneii_lcell_comb
-- Equation(s):
-- \Decoder2~0_combout\ = (\SW~combout\(1)) # (\SW~combout\(0))
...
-- Equation(s):
-- \WideOr1~0_combout\ = \SW~combout\(2) $ (((\SW~combout\(1)) # (\SW~combout\(0))))
...
-- Equation(s):
-- \WideOr0~0_combout\ = ((!\SW~combout\(1) & !\SW~combout\(0))) # (!\SW~combout\(2))
...
-- Equation(s):
-- \Decoder0~0_combout\ = (\SW~combout\(2)) # (\SW~combout\(1))
